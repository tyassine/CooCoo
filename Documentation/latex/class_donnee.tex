...
\begin{DoxyCompactList}\small\item\em Méthode permettant d'obtenir l'objet sous la forme d'une Q\-String. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Retourne une \hyperlink{class_donnee}{Donnee} ayant les memes valeurs mais avec le signe inversé \end{DoxyCompactList}\item 
...
Méthode virtuelle pure pour l'opérateur unaire Cube \begin{DoxyReturn}{Returns}
Pointeur sur donnee, resultat de l'operation 
\end{DoxyReturn}
...
Méthode virtuelle pure pour l'opérateur unaire fact \begin{DoxyReturn}{Returns}
Pointeur sur donnee, resultat de l'operation 
\end{DoxyReturn}
...
Méthode virtuelle pure pour l'opérateur unaire inv \begin{DoxyReturn}{Returns}
Pointeur sur donnee, resultat de l'operation 
\end{DoxyReturn}
...
Méthode virtuelle pure pour l'opérateur unaire ln \begin{DoxyReturn}{Returns}
Pointeur sur donnee, resultat de l'operation 
\end{DoxyReturn}
...
Méthode virtuelle pure pour l'opérateur unaire log \begin{DoxyReturn}{Returns}
Pointeur sur donnee, resultat de l'operation 
\end{DoxyReturn}
...
Méthode virtuelle pure pour l'opérateur unaire sqr \begin{DoxyReturn}{Returns}
Pointeur sur donnee, resultat de l'operation 
\end{DoxyReturn}
...
Méthode virtuelle pure pour l'opérateur unaire sqrt \begin{DoxyReturn}{Returns}
Pointeur sur donnee, resultat de l'operation 
\end{DoxyReturn}
...
Méthode virtuelle pure pour l'opérateur binaire $\ast$ 
\begin{DoxyParams}{Parameters}
...
Retourne une \hyperlink{class_donnee}{Donnee} ayant les memes valeurs mais avec le signe inversé 
...
Méthode permettant d'obtenir l'objet sous la forme d'une Q\-String. 
