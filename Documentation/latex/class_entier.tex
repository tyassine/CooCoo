...
\begin{DoxyCompactList}\small\item\em Retourne un \hyperlink{class_entier}{Entier} ayant les memes valeurs mais avec le signe inversé \end{DoxyCompactList}\item 
...
Retourne un \hyperlink{class_entier}{Entier} ayant les memes valeurs mais avec le signe inversé 
