\hypertarget{class_complexe}{\section{R√©f√©rence de la classe Complexe}
\label{class_complexe}\index{Complexe@{Complexe}}
}


Classe modÈlisant les complexes. Elle hÈrite de \hyperlink{class_donnee}{Donnee}.  
...
Graphe d'h√©ritage de Complexe\-:\begin{figure}[H]
\begin{center}
\leavevmode
...
\begin{DoxyCompactList}\small\item\em Constructeur de \hyperlink{class_complexe}{Complexe} ‡ partir d'une \hyperlink{class_donnee}{Donnee} initiale et selon un type souhaitÈ \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Accesseur ‡ la partie rÈelle. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Construit le conjuguÈ du \hyperlink{class_complexe}{Complexe}. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Retourne un \hyperlink{class_complexe}{Complexe} ayant les memes valeurs mais avec le signe inversÈ \end{DoxyCompactList}\item 
...
Letellier/\-Yassine
\end{DoxyAuthor}
Pour fonctionner cette classe encapsule deux Constantes \-: sa partie rÈelle et sa partie imaginaire. Tous les opÈrateurs sont Ègalements redÈfinis. 
...
Constructeur de \hyperlink{class_complexe}{Complexe} ‡ partir d'une \hyperlink{class_donnee}{Donnee} initiale et selon un type souhaitÈ 


\begin{DoxyParams}{Param√®tres}
{\em donnee\-Depart} & Pointeur vers la \hyperlink{class_donnee}{Donnee} contenant les valeurs nous intÈressant \\
\hline
...
\begin{DoxyParams}{Param√®tres}
{\em D1} & \hyperlink{class_constante}{Constante} initialisant la partie rÈelle \\
\hline
...
Construit le conjuguÈ du \hyperlink{class_complexe}{Complexe}. 
...
Accesseur ‡ la partie rÈelle. 

\begin{DoxyReturn}{Renvoie}
Retourne l'attribut-\/pointeur vers la partie rÈelle du \hyperlink{class_complexe}{Complexe}. 
\end{DoxyReturn}
...
ImplÈmentation de l'operateur binaire modulo (methode virtuelle dans la classe mere) 
\begin{DoxyParams}{Param√®tres}
...
ImplÈmentation de l'operateur unaire cosinus (methode virtuelle dans la classe mere) 
\begin{DoxyParams}{Param√®tres}
...
ImplÈmentation de l'operateur unaire cosinush (methode virtuelle dans la classe mere) 
\begin{DoxyParams}{Param√®tres}
{\em type\-Angle} & \-: entier, 0 si utilisation des degres, 1 si utilisation des radians \\
\hline
\end{DoxyParams}
...
ImplÈmentation de l'operateur unaire Cube (methode virtuelle dans la classe mere) \begin{DoxyReturn}{Renvoie}
Pointeur sur donnee, resultat de l'operation 
\end{DoxyReturn}
...
ImplÈmentation de l'operateur unaire fact (methode virtuelle dans la classe mere) \begin{DoxyReturn}{Renvoie}
Pointeur sur donnee, resultat de l'operation 
\end{DoxyReturn}
...
ImplÈmentation de l'operateur unaire inv (methode virtuelle dans la classe mere) \begin{DoxyReturn}{Renvoie}
Pointeur sur donnee, resultat de l'operation 
\end{DoxyReturn}
...
ImplÈmentation de l'operateur unaire ln (methode virtuelle dans la classe mere) \begin{DoxyReturn}{Renvoie}
Pointeur sur donnee, resultat de l'operation 
\end{DoxyReturn}
...
ImplÈmentation de l'operateur unaire log (methode virtuelle dans la classe mere) \begin{DoxyReturn}{Renvoie}
Pointeur sur donnee, resultat de l'operation 
\end{DoxyReturn}
...
ImplÈmentation de l'operateur unaire sinus (methode virtuelle dans la classe mere) 
\begin{DoxyParams}{Param√®tres}
{\em type\-Angle} & \-: entier, 0 si utilisation des degres, 1 si utilisation des radians \\
\hline
\end{DoxyParams}
...
ImplÈmentation de l'operateur unaire sinush (methode virtuelle dans la classe mere) 
\begin{DoxyParams}{Param√®tres}
{\em type\-Angle} & \-: entier, 0 si utilisation des degres, 1 si utilisation des radians \\
\hline
\end{DoxyParams}
...
ImplÈmentation de l'operateur unaire sqr (methode virtuelle dans la classe mere) \begin{DoxyReturn}{Renvoie}
Pointeur sur donnee, resultat de l'operation 
\end{DoxyReturn}
...
ImplÈmentation de l'operateur unaire sqrt (methode virtuelle dans la classe mere) \begin{DoxyReturn}{Renvoie}
Pointeur sur donnee, resultat de l'operation 
\end{DoxyReturn}
...
ImplÈmentation de l'operateur unaire tangente (methode virtuelle dans la classe mere) 
\begin{DoxyParams}{Param√®tres}
{\em type\-Angle} & \-: entier, 0 si utilisation des degres, 1 si utilisation des radians \\
\hline
\end{DoxyParams}
...
ImplÈmentation de l'operateur unaire tangenteh (methode virtuelle dans la classe mere) 
\begin{DoxyParams}{Param√®tres}
{\em type\-Angle} & \-: entier, 0 si utilisation des degres, 1 si utilisation des radians \\
\hline
\end{DoxyParams}
...
ImplÈmentation de l'opÈrateur binaire $\ast$ (mÈthode virtuelle dans la classe mere) 
\begin{DoxyParams}{Param√®tres}
{\em t} & \-: Pointeur sur un type \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Renvoie}
Pointeur sur type, resultat de l'opÈration 
\end{DoxyReturn}
...
ImplÈmentation de l'opÈrateur binaire + (methode virtuelle dans la classe mere) 
\begin{DoxyParams}{Param√®tres}
{\em t} & \-: Pointeur sur un type \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Renvoie}
Pointeur sur type, rÈsultat de l'operation 
\end{DoxyReturn}
...
ImplÈmentation de l'operateur binaire -\/ (methode virtuelle dans la classe mere) 
\begin{DoxyParams}{Param√®tres}
{\em t} & \-: Pointeur sur un type \\
\hline
\end{DoxyParams}
...
ImplÈmentation de l'opÈrateur binaire / (mÈthode virtuelle dans la classe mere) 
\begin{DoxyParams}{Param√®tres}
{\em t} & \-: Pointeur sur un type \\
\hline
\end{DoxyParams}
...
ImplÈmentation de l'operateur binaire puissance (methode virtuelle dans la classe mere) 
\begin{DoxyParams}{Param√®tres}
{\em Donnee$\ast$,\-:} & Pointeur sur une donnee \\
\hline
\end{DoxyParams}
...
Retourne un \hyperlink{class_complexe}{Complexe} ayant les memes valeurs mais avec le signe inversÈ 
...
\begin{DoxyReturn}{Renvoie}
Elle retourne une Q\-String dÈfinissant et reprÈsentant le \hyperlink{class_complexe}{Complexe}. 
\end{DoxyReturn}
