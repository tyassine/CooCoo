...
{\em const} & std\-::string\&, chaine de caractere servant à l'initialisation de l'attribut log \\
\hline
{\em unsigned} & int, entier servant à l'initialisation du degree du message imp \\
\hline
\end{DoxyParams}
