\hypertarget{class_reel}{\section{R√©f√©rence de la classe Reel}
\label{class_reel}\index{Reel@{Reel}}
}


Classe des reels hÈritant de \hyperlink{class_constante}{Constante}.  
...
Graphe d'h√©ritage de Reel\-:\begin{figure}[H]
\begin{center}
\leavevmode
...
\begin{DoxyCompactList}\small\item\em Fonction permettant de calculer le nombre digit de this aprËs la virgule. \end{DoxyCompactList}\item 
\hyperlink{class_reel}{Reel} $\ast$ \hyperlink{class_reel_ae80b92f821de4ad1dc327ff7bdd5fc0e}{sign} ()
\begin{DoxyCompactList}\small\item\em Retourne un reel ayant les meme valeur mais avec le sign inversÈ \end{DoxyCompactList}\item 
...
Letellier/\-Yassine
\end{DoxyAuthor}
Pour fonctionner cette classe encapsule un double. Tout les opÈrateurs sont Ègalement redÈfinis. 
...
Fonction permettant de calculer le nombre digit de this aprËs la virgule. 

\begin{DoxyReturn}{Renvoie}
Elle retourne le nombre de de chiffre aprËs la virgule. 
\end{DoxyReturn}
...
Retourne un reel ayant les meme valeur mais avec le sign inversÈ 
...
\begin{DoxyReturn}{Renvoie}
Elle retourne un Qstring tel qu'un reel puisse etre construit ou affichÈ ‡ partir de Áa. 
\end{DoxyReturn}
