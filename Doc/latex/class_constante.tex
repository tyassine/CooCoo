...
\begin{DoxyCompactList}\small\item\em sign Methode virtuelle pure \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Letellier/\-Yassine
\end{DoxyAuthor}
Il s'agit d'une classe abstraite dérivant de \hyperlink{class_donnee}{Donnee}. 
